...
SELECT name, owner.table_name AS table_name, sql FROM __genji_catalog WHERE type = "index";
/* result:
{
  "name": "test_a_idx",
  "table_name": "test",
...
CREATE INDEX ON test(a);
SELECT name, owner.table_name AS table_name, sql FROM __genji_catalog WHERE type = "index" ORDER BY name;
/* result:
{
  "name": "test_a_idx",
  "table_name": "test",
