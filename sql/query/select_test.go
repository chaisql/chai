...
func TestSelectStmt(t *testing.T) {
	tests := []struct {
		...
		{"With order by", "SELECT * FROM test ORDER BY b", false, "3,foo3,bar2\n1,foo1,bar1,baz1\n2,foo2,bar1,1\n", nil},
		{"With order by asc", "SELECT * FROM test ORDER BY k ASC", false, "1,foo1,bar1,baz1\n2,foo2,bar1,1\n3,foo3,bar2\n", nil},
		{"With order by desc", "SELECT * FROM test ORDER BY k DESC", false, "3,foo3,bar2\n2,foo2,bar1,1\n1,foo1,bar1,baz1\n", nil},
