...
func TestScanner_Scan(t *testing.T) {
	var tests = []struct {
		...
		{s: "UINT8", tok: scanner.TYPEUINT8, raw: `UINT8`},
		{s: "UINT16", tok: scanner.TYPEUINT16, raw: `UINT16`},
		{s: "UINT32", tok: scanner.TYPEUINT32, raw: `UINT32`},
		{s: "UINT64", tok: scanner.TYPEUINT64, raw: `UINT64`},
		{s: "UINT", tok: scanner.TYPEUINT, raw: `UINT`},
