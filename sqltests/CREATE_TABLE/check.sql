...
/* result:
{
  name: "test",
  type: "table",
  sql: "CREATE TABLE test (a INTEGER NOT NULL DEFAULT 0, CONSTRAINT test_check CHECK (a > 10)), CONSTRAINT test_pk PRIMARY KEY (a))"
}
*/
...
/* result:
{
  name: "test",
  type: "table",
  sql: "CREATE TABLE test (a INTEGER NOT NULL, b INTEGER, CONSTRAINT test_check CHECK (a > 10 AND b < 10)), CONSTRAINT test_pk PRIMARY KEY (a))"
}
*/
